...
default_alphabet = "air bat cap drum each fine gust harp sit johnny crunch look made near odd pit quench red sun trap urge vest whale plex yank zip".split(
    " "
)
